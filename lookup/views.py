...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + str(zipcode) + "&distance=25&API_KEY=A4C73258-C694-4AC4-8680-5B8284D5D581")
        try:
        ...
        return render(request, 'home.html', {'api': api, 'description': description, 'category_color': category_color, 'zipcode': zipcode})

    else:
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=11217&distance=25&API_KEY=A4C73258-C694-4AC4-8680-5B8284D5D581")
        ...
        return render(request, 'home.html', {'api': api, 'description': description, 'category_color': category_color})
